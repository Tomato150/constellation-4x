    ...
    def generate_galaxy(self):
        ...
        while True:
            ...
            if not distance < self.galaxy_creation_parameters['galactic_center_cutoff']:
                ...
                star_x = int(
                    math.cos(angle) * distance * (self.galaxy_creation_parameters['size_of_canvas'] / 50 * 49) / 2)
                star_y = int(
                    math.sin(angle) * distance * (self.galaxy_creation_parameters['size_of_canvas'] / 50 * 49) / 2)
